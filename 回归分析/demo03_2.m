...
% 计算给定年龄处头围预测值和预测区间
[ypred,delta] = nlpredci(@HeadCir,xx,beta,r,'covar',COVB,'mse',mse, ...
                            'predopt','observation');
